...
const Login = () => {
  ...
  return (
    <>
      ...
      <Outlet></Outlet>
      <p className='mt-5'>{showForm ? strings.auth.noAccount : strings.auth.hasAccount}</p>
      <button
        className='bg-[#982A2a70]! text-black border-2 border-stone-300! hover:bg-[#982A2a90]!' onClick={() => {
          handleButton();
        }}
      >
