...
INSERT INTO menu_items (category_id, name, name_en, description, description_en, price, ingredients, spice_level, allows_spice_custom, available_proteins, default_protein, image_url, is_available) VALUES

(1, 'Maissilastut', 'Corn Chips', 'Rapeita maissilastuja, guacamolea sekä raikas tomaattisalsa (pico de gallo)', 'Crispy corn chips served with guacamole and fresh tomato salsa (pico de gallo)', 7.90, 'corn chips, guacamole, tomato salsa', 0, FALSE, NULL, NULL, '/images/corn_chips.jpg', TRUE),
...
(1, 'Chili-mustapapu tostada', 'Chili Black Bean Tostada',
 ...
 6.90, 'corn tortilla, black beans, corn, guacamole, coriander', 1, FALSE, NULL, NULL, '/images/tostada.jpg', TRUE),
 ...
 14.50, 'corn tortillas, chicken, chili sauce, coriander', 1, FALSE, NULL, NULL, '/images/chicken-tacos.jpg', TRUE),
...
(2, 'Nautatacot x 3', 'Beef Tacos x 3',
 ...
 14.50, 'corn tortillas, beef, salsa verde, onions', 1, FALSE, NULL, NULL, '/images/beef-tacos.jpg', TRUE),
...
(2, 'Vegaaniset tacot x 3', 'Vegan Tacos x 3',
 ...
 14.50, 'corn tortillas, plant protein, black bean salsa, coriander', 1, FALSE, NULL, NULL, '/images/vegan-tacos.jpg', TRUE),
...
(2, 'Katkaraputacot x 3', 'Shrimp Tacos x 3',
 ...
 14.50, 'corn tortillas, shrimp, salsa verde, onion, lime', 1, FALSE, NULL, NULL, '/images/shrimp-tacos.jpg', TRUE),
...
(2, 'Burrito', 'Burrito',
 ...
 16.90, 'wheat tortilla, rice, black beans, corn, chili sauce', 2, TRUE, 'chicken, beef, vegan, shrimp', 'beef', '/images/burrito.jpg', TRUE),
...
(2, 'Burrito bowl', 'Burrito bowl',
 ...
 16.90, 'lime rice, salad, black beans, peppers, pico de gallo', 2, TRUE, 'chicken, beef, vegan, shrimp', 'beef', '/images/bowl.jpg', TRUE),

(3, 'Churrot', 'Churros',
 'Churroja & suklaakastiketta',
 'Churros with chocolate dipping sauce',
 7.90, 'churros, chocolate sauce', 0, FALSE, NULL, NULL, '/images/churros.jpg', TRUE),

(3, 'Flan', 'Flan',
 'Klassinen meksikolainen karamellivanukas',
 'Classic Mexican caramel custard',
 7.90, 'eggs, milk, sugar, caramel', 0, FALSE, NULL, NULL, '/images/flan.jpg', TRUE),
...
(4, 'Jarritos Lime', 'Jarritos Lime',
 ...
 3.90, 'lime soda', 0, FALSE, NULL, NULL, '/images/jarritos-lime.jpg', TRUE),
...
(4, 'Jarritos Guava', 'Jarritos Guava',
 ...
 3.90, 'guava soda', 0, FALSE, NULL, NULL, '/images/jarritos-guava.jpg', TRUE),

(4, 'Agua De Jamaica', 'Agua De Jamaica',
 '370 ml kirpeän raikas hibiscus-jäätee',
 '370 ml tart and refreshing hibiscus iced tea',
 3.90, 'hibiscus tea', 0, FALSE, NULL, NULL, '/images/agua.jpg', TRUE);
